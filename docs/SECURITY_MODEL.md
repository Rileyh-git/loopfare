...
This document describes the security properties and trust boundaries of Loopfare 0.2.2. It is a design description, not a security certification. Review it before exposing an instance to untrusted sellers, buyers, or origins.
