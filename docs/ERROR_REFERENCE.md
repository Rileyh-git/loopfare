...
This reference covers Loopfare `0.3.1`. Always record the response status, body, and `X-Request-Id`. Payment-protocol errors can also carry `PAYMENT-REQUIRED` or `PAYMENT-RESPONSE`.
